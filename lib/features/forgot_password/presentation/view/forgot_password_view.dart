...
import 'package:final_assignment/features/forgot_password/presentation/viewmodel/forgot_password_view_model.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ref.read(loginNavigatorProvider).openForgotPasswordView();
            },
